class SemanticChecker:
    ...
    def error(self, error_type, line_number, *args):
        if error_type == 'scoping':
            ...
            self.errors += '#{} : Semantic Error! No \'while\' or \'switch\' found for \'break\'.\n'.format(line_number)
            ...
            self.errors += '#{} : Semantic Error! Mismatch in type of argument \'{}\' for \'{}\'. ' \
                           'Expected \'{}\' but got \'{}\' instead.\n'.format(line_number, args[0], args[1], args[2],
                                                                              args[3])
